 ...
 */
    ...
    (() => {
        ...
        document.getElementById("burgerID");
        window.addEventListener("scroll", (() => {
            let scrollTop = window.pageXOffset || document.documentElement.scrollTop;
            if (scrollTop > lastScrollTop) headerHide.style.top = "-90px"; else headerHide.style.top = 0;
        ...
        document.getElementById("footer").addEventListener("click", upHeader);
        function imagesFilter() {
            const images = document.querySelectorAll(".articles__image");
            if (images.length) images.forEach((image => {
                ...
                imageItem.classList.add("filter");
            }));
        }
        function gridInit() {
            ...
            function documentActions(e) {
                ...
                if (targetElement.closest(".filter-gallery__btn")) {
                    const filterItem = targetElement.closest(".filter-gallery__btn");
                    const filterValue = filterItem.dataset.filter;
                    const filterActiveItem = document.querySelector(".filter-gallery__btn.active");
        ...
        const transition = document.querySelectorAll("*");
        ...
        function dom7_esm_transition(duration) {
        ...
        const Methods = {
            ...
            removeAttr,
            transform,
            transition: dom7_esm_transition,
            on,
            off,
            trigger,
            transitionEnd,
